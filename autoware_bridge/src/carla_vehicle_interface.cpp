...
CarlaVehicleInterface::CarlaVehicleInterface(): Node("carla_vehicle_interface_node")
{
    ...
    sub_control = this->create_subscription<autoware_auto_control_msgs::msg::AckermannControlCommand>("/control/command/control_cmd", 10, std::bind(&CarlaVehicleInterface::controlCb, this, _1));
}
