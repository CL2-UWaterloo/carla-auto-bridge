...
class CarlaSpawnObjects(CompatibleNode):
    ...
    def __init__(self):
        ...
        self.objects_definition_file = self.get_param('objects_definition_file', '/home/waterloo/ros-ws/carla-auto-bridge/src/carla_spawn_objects/config/objects.json')
